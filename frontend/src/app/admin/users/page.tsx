...
export default function ProfileUsersPage() {
  ...
  return (
    <div className="p-8">
  <h1 className="text-2xl font-bold mb-5">Alla användare</h1>
  {users.length === 0 ? (
    ...
    <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
      {users.map((u) => (
        <div
          key={u.profileuser_id}
          className="border rounded-2xl p-6 shadow-md bg-white transition-shadow text-2xl text-gray-950 "
        >
              ...
              <div className="flex items-center gap-2">
                ...
                <label>
                  <input
                    ...
                    onChange={(e) => setEditForm((f) => ({ ...f, ispropertyowner: e.target.checked }))}
                  />{" "}
                  Property Owner
                </label>
              </div>
